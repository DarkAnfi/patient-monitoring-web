...
const initialState: PatientState = {
    patients: [{
        ...
        EVALUADO  EN HHHA  15/03, POR CUADRO DE AUMENTO DE VOLUMEN EN CARA MEDIAL MUSLO IZQUIERDO DESDE NOVIEMBRE 2021, ASOCIADO A CRECIMIENTO GRADUAL Y DOLOR. ES EVALUADO A APS Y DERIVADO PARA EVALUACIÓN EQUIPO TRAUMATOLOGIA TUMORES. SE INGRESA A LISTA ESTERA QUIRURGICA PARA BIOPSIA LESION`,
        prevision: 'Fonasa D',
